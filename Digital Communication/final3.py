...
import final3_epy_block_0 as epy_block_0  # embedded python block



from gnuradio import qtgui

class final3(gr.top_block, Qt.QWidget):
    ...
    def __init__(self, MTU=1500, puncpat='11'):
        ...
        self.settings = Qt.QSettings("GNU Radio", "final3")
...
def main(top_block_cls=final3, options=None):
    if options is None:
